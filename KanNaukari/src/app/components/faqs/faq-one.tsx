...
const FaqOne = () => {
  return (
    <>
      <section className="faq-section position-relative mt-20 xl-mt-150 lg-mt-100 mb-20 lg-mb-100">
        <div className="container">
          <div className="title-one text-center">
            <h2 className="text-dark wow fadeInUp" data-wow-delay="0.3s">Questions & Answers</h2>
          </div>
          <div className="bg-wrapper mt-30 lg-mt-40">
            <FaqItems/>
          </div>
          <div className="text-center mt-30 sm-mt-40 wow fadeInUp pb-20">
