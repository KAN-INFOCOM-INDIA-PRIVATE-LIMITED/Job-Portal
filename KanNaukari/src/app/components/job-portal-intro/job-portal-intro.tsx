...
const JobPortalIntro = ({top_border=false}:{top_border?:boolean}) => {
  return (
    <>{localStorage.getItem("reg_Id")==null?(
    <section className="job-portal-intro ">
      <div className="container ">
        <div className={`wrapper bottom-border ${top_border?'top-border':''} pt-20 lg-pt-80 md-pt-50 mb-20 md-pb-50 mt-background-color`}>
          <div className="row align-items-center">
            ...
            <div className="col-lg-5">
              <ul className="btn-group style-none d-flex flex-wrap justify-content-center justify-content-lg-end">
                ...
                <li className="ms-2">
                  <Link href="/dashboard/employ-dashboard/submit-job" className="btn-four">
                    Post a job
                  </Link>
                </li>
              </ul>
